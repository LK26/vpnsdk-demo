...
- (nonnull instancetype)initWithSuitName:(NSString * _Nonnull)suitName OBJC_DESIGNATED_INITIALIZER;
- (void)updateCredentialsIfNeedFor:(NSDictionary<NSString *, id> * _Nonnull)config completion:(void (^ _Nonnull)(NSError * _Nullable, NSDictionary<NSString *, id> * _Nullable))completion;
...
+ (NSURL * _Nullable)extensionLogFileURLWithGroupID:(NSString * _Nonnull)groupID SWIFT_WARN_UNUSED_RESULT;
@end
...
- (void)markThatCurrentSessionWentToSleep;
- (void)appendErrorToCurrentSession:(NSError * _Nonnull)error;
- (void)assignPreviousSessionErrorsToCurrentSession;
- (void)saveCurrentSession;
- (void)clearSessionsData;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface SessionDataStorage (SWIFT_EXTENSION(VPNTunnelProviderSDK))
@property (nonatomic, readonly, copy) NSArray<NSError *> * _Nullable previousSessionErrors;
@property (nonatomic, readonly) BOOL previousSessionHasErrors;
@property (nonatomic, readonly) BOOL previousSessionHasErrorToBypass;
@property (nonatomic, readonly) BOOL previousSessionHasEstablishingError;
@property (nonatomic, readonly) BOOL previousSessionWentToSleep;
- (BOOL)isPreviousSessionsWithErrorsExceededWithLimit:(NSUInteger)limit SWIFT_WARN_UNUSED_RESULT;
@end
...
enum ProtocolType : NSInteger;

SWIFT_CLASS("_TtC20VPNTunnelProviderSDK10VPNTracker")
@interface VPNTracker : NSObject
@property (nonatomic, readonly, strong) VPNConnectionData * _Nonnull connectionData;
- (nonnull instancetype)initWithProtocolType:(enum ProtocolType)protocolType appGroup:(NSString * _Nullable)appGroup projectID:(NSString * _Nullable)projectID sdkVersion:(NSString * _Nullable)sdkVersion hydraVersion:(NSString * _Nullable)hydraVersion OBJC_DESIGNATED_INITIALIZER;
...
typedef SWIFT_ENUM(NSInteger, ProtocolType, closed) {
  ProtocolTypeHydra = 0,
  ProtocolTypeIpsec = 1,
};
