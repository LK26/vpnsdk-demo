...
@property (nonatomic, readonly, strong) AFTrafficCounters * _Nullable hydraTrafficCounters;
...
@property (nonatomic, readonly, strong) AFHydraCategorization * _Nullable lastHydraCategorization;
@property (nonatomic, readonly) NSError * _Nullable lastHydraError;
...
- (nonnull instancetype)initWithHostURL:(NSString * _Nullable)hostURL carrierID:(NSString * _Nonnull)carrierID extensionBundleID:(NSString * _Nonnull)extensionBundleID groupID:(NSString * _Nonnull)groupID profileName:(NSString * _Nonnull)profileName debugLogging:(BOOL)debugLogging fireshieldConfig:(FireshieldConfig * _Nonnull)fireshieldConfig serverAddressDisplayName:(NSString * _Nullable)serverAddressDisplayName dnsAddress:(NSString * _Nullable)dnsAddress bypassDomains:(NSArray<NSString *> * _Nullable)bypassDomains onDemandRules:(NSArray<NEOnDemandRule *> * _Nullable)onDemandRules isBypassEnabled:(BOOL)isBypassEnabled isVPNIconFixEnabled:(BOOL)isVPNIconFixEnabled isOnDemandEnabled:(BOOL)isOnDemandEnabled isClientListEnabled:(BOOL)isClientListEnabled deviceType:(NSString * _Nullable)deviceType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (nonnull instancetype)initWithHostURL:(NSString * _Nullable)hostURL carrierID:(NSString * _Nonnull)carrierID debugLogging:(BOOL)debugLogging isOnDemandEnabled:(BOOL)isOnDemandEnabled onDemandRules:(NSArray<NEOnDemandRule *> * _Nullable)onDemandRules profileName:(NSString * _Nonnull)profileName deviceType:(NSString * _Nullable)deviceType OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
